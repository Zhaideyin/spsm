					...
					<#if var[3] == "是">
						...
						<#elseif var[1] == 'File'>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">${var[2] }:</td>
								<td>
								<div class='filepicker' path='${var[0] }'>选择文件</div>
								<input style='visibility:hidden' type="text" name="${var[0] }" id="${var[0] }" value="${r"${pd."}${var[0] }${r"}"}" maxlength="${var[5] }" placeholder="这里输入${var[2] }" title="${var[2] }" /></td>
							</tr>
						<#else>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">${var[2] }:</td>
