package com.ronxuntech.controller.spsm.person;
...
import com.ronxuntech.service.spsm.person.PersonManager;
...
public class PersonController extends BaseController {
	...
	String menuUrl = "person/list.do"; //菜单地址(权限用)
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"新增Person");
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"删除Person");
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改Person");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"列表Person");
		...
		mv.setViewName("spsm/person/person_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("spsm/person/person_edit");
	...
	public Object deleteAll() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"批量删除Person");
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"导出Person到excel");
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("ORGANIZATION"));	//2
			vpd.put("var3", varOList.get(i).getString("SEX"));	//3
			vpd.put("var4", varOList.get(i).getString("SCHOOL_RECORD"));	//4
			...
			vpd.put("var9", varOList.get(i).getString("DESCRIPTION"));	//9
			vpd.put("var10", varOList.get(i).getString("KEYWORDS"));	//10
			vpd.put("var11", varOList.get(i).getString("CREATE_TIME"));	//11
			vpd.put("var12", varOList.get(i).getString("HIT"));	//12
			varList.add(vpd);
		}
