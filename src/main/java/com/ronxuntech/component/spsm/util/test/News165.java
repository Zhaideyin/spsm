...
public class News165 implements MultiPageModel {
    ...
    public MultiPageModel combine(MultiPageModel multiPageModel) {
        News165 news163 = new News165();
        news163.title = this.title;
        News165 pagedModel1 = (News165) multiPageModel;
    ...
    public static void main(String[] args) {
        OOSpider.create(Site.me(), News165.class).addUrl("http://news.163.com/13/0802/05/958I1E330001124J_2.html")
