package api.ronxuntech.controller.spsm.targeturl;
 ...
 */
@RestController
@RequestMapping(value = "/api/targeturl")
public class TargetUrlApiController extends BaseController {
	...
	public Map list(int page,int count) throws Exception {
		...
		List<PageData> varList = targeturlService.list(pg);	//列出TargetUrl列表,有分页
    ...
    public Object info() throws Exception {
		...
		return targeturlService.findById(pd);
    }
