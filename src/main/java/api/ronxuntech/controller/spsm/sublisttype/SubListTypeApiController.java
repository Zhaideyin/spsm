package api.ronxuntech.controller.spsm.sublisttype;
 ...
 */
@RestController
@RequestMapping(value = "/api/sublisttype")
public class SubListTypeApiController extends BaseController {
	...
	public Map list(int page,int count) throws Exception {
		...
		List<PageData> varList = sublisttypeService.list(pg);	//列出SubListType列表,有分页
    ...
    public Object info() throws Exception {
		...
		return sublisttypeService.findById(pd);
    }
