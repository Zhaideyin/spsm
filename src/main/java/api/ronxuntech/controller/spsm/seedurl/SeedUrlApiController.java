package api.ronxuntech.controller.spsm.seedurl;
 ...
 */
@RestController
@RequestMapping(value = "/api/seedurl")
public class SeedUrlApiController extends BaseController {
	...
	public Map list(int page,int count) throws Exception {
		...
		List<PageData> varList = seedurlService.list(pg);	//列出SeedUrl列表,有分页
    ...
    public Object info() throws Exception {
		...
		return seedurlService.findById(pd);
    }
