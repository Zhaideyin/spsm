package api.ronxuntech.controller.socket.socketport;
 ...
 */
@RestController
@RequestMapping(value = "/api/socketport")
public class SocketPortApiController extends BaseController {
	...
	public Map list(int page,int count) throws Exception {
		...
		List<PageData> varList = socketportService.list(pg);	//列出SocketPort列表,有分页
    ...
    public Object info() throws Exception {
		...
		return socketportService.findById(pd);
    }
