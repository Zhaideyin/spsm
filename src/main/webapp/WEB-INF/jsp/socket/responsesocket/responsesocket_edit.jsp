		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="responsesocket/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="RESPONSESOCKET_ID" id="RESPONSESOCKET_ID" value="${pd.RESPONSESOCKET_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">报文:</td>
								<td><input type="text" name="CONTENT" id="CONTENT" value="${pd.CONTENT}" maxlength="255" placeholder="这里输入报文" title="报文" style="width:98%;"/></td>
							</tr>
							<tr>
