		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="seedurl/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="SEEDURL_ID" id="SEEDURL_ID" value="${pd.SEEDURL_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">种子地址:</td>
								<td><input type="text" name="SEEDURL" id="SEEDURL" value="${pd.SEEDURL}" maxlength="255" placeholder="这里输入种子地址" title="种子地址" style="width:98%;"/></td>
							</tr>
							<tr>
