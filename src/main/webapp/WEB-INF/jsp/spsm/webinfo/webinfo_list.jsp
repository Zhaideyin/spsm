                        ...
                        <form action="webinfo/list.do" method="post" name="Form" id="Form">
                            ...
                            <table id="simple-table" class="table table-striped table-bordered table-hover"
                                ...
                                <tr>
                                    ...
                                    <th class="center" style="width: auto">种子地址</th>
                                    <th class="center" style="width:10%">类型</th>
                                    <th class="center" style="width: 12%">创建时间</th>
                                                    ...
                                                    <td class='center'>
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${var.LISTTYPEID!='' && var.LISTTYPEID!=null}">
                                                                <c:forEach items="${pd.listtype}" var="li">
                                                                    <c:if test="${var.LISTTYPEID==(li.LISTTYPE_ID)}">
                                                                        ${li.LISTTYPENAME }
                                                                    </c:if>
                                                                </c:forEach>
                                                            </c:when>
                                                            ...
                                                            <c:when test="${var.NAVBARTYPEID!='' && var.NAVBARTYPEID!=null}">
                                                                <c:forEach items="${pd.navbarTypeList}" var="nav">
                                                                    <c:if test="${var.NAVBARTYPEID==nav.NAVBARTYPE_ID}">
                                                                        ${nav.NAVBARTYPENAME }
                                                                    </c:if>
                                                                </c:forEach>
                                                            </c:when>

                                                            <c:when test="${var.DATABASETYPEID!=null && var.DATABASETYPEID!=''}">
                                                                <c:forEach items="${pd.databaseTypeList}" var="data">
                                                                    <c:if test="${var.DATABASETYPEID==data.DATABASETYPE_ID}">
                                                                        ${data.DATABASETYPENAME }
                                                                    </c:if>
                                                                </c:forEach>
                                                            </c:when>
                                                        </c:choose>
                                ...
                                <table style="width:100%;">
                                    <tr>
                                        <td style="vertical-align:top;">
                                            ...
                                            <c:if test="${QX.del == 1 }">
                                                <a class="btn btn-sm btn-danger" onclick="makeAll('确定要删除选中的数据吗?');"
