		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="listtype/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="LISTTYPE_ID" id="LISTTYPE_ID" value="${pd.LISTTYPE_ID}"/>
						<div id="zhongxin" style="padding-top: 13px;">
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">列表名:</td>
