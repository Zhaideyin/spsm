	...
	<div class="main-content">
						        	...
						        	<table>
						        		<tr height="42px;">
						        			...
						        			<td style="padding-bottom: 5px;">
												...
												<label style="float:left;padding-left: 20px;"><input name="form-field-radiot" id="form-field-radio3" onclick="setType('File');" type="radio" value="icon-edit"><span class="lbl">File</span></label>
											</td>
						        		</tr>
						        		<tr height="42px;">
					...
					<form action="createCode/proCode.do" name="Form" id="Form" method="post">
						...
						<table style="margin-top: 10px;" border="0">
							<tr>
								<td style="width:76px;text-align: right;">生成路径：</td>
								<td colspan="1"><div class="nav-search"><input class="nav-search-input" type="text" name="BASEDIR" id="BASEDIR" value="" placeholder="生成的代码路径" style="width:666px;" title="路径"/></div></td>
							</tr>
						</table>
						<table style="margin-top: 10px;" border="0">
							<tr>
						...
						<table style="margin-top: 5px;">
							<tr>
								...
								<td>&nbsp;&nbsp;例如:com.ronxuntech.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;只输入红色部分</td>
							</tr>
						</table>
						<table style="margin-top: 5px;">
							<tr>
